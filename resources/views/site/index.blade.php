...
<div class="jumbotron jumbotron-fluid p-4">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <h3>O QUE FAZEMOS?</h1>
                <p class="lead">Especializados em soluções de tecnologia para qualquer tipo de negócio, meu objetivo é prestar o melhor serviço para sua empresa como funcionário PJ, sou especializado em desenvolver soluções com boas práticas e que sejam agradáveis para seu usuário! Seja por demanda de documentações ou para criação de novos sistemas.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid mt-3">
    ...
    <div class="row text-center">
            ...
            <div class="col-md-4 my-4">
                ...
                <h6 class="mt-1">A parte que uso para encontrar o melhor visual para seu site/sistema. É usado para deixar seu usuário confortável e para criar uma comunicação que cative o cliente, dando credibilidade e atraindo novos clientes.</h6>
            </div>
    ...
    <div class="row text-center">
        <div class="col-md-4 my-4">
            <i class="fab fa-bootstrap fa-4x" style="color:#7a257a "></i><br>
                ...
                <h6 class="mt-1">Um framework que facilita muito o trabalho front-end, e nos possibilita trabalhar com padrões de grid, também trabalho com outros frameworks como Tailwind.</h6>
        </div>  
        <div class="col-md-4 my-4">
            <img src="{{ asset('/img/mysql.png') }}" style="width: 20%">
                <h6 class="mt-1">O MySQL é simplesmente o sistema mais popular para armazenar e gerenciar dados com segurança, sempre que começo uma aplicação do zero opto por utilizá-lo, mas já trabalhei com diversos outros.</h6>
        </div>  
        <div class="col-md-4 my-4">
...
<div class="container-fluid mt-1">
    ...
    <div class="row bg-dark">
        <div class="col-md-6 bordado my-auto text-light">
            ...
            <h5 id="text-center-mobile">Eu crio sites e sistemas de maneira 100% profissional para seu negócio, indepentende do ramo. Tenho alta experiência com solucionamento de quaisquer problemas que sua empresa esteja enfrentando, além de estudar e implantar novas funcionalidades, criando e desenvolvendo soluções em tecnologia planejadas baseada em documentações ou sprints.</h5>
            <br>
        ...
        <div class="col-md-6">
            <div id="carouselExampleControls1" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <video id="video" class="d-block w-100" src="{{ asset('video/video1.mp4') }}" muted autoplay playsinline />
                    </div>
                    <div class="carousel-item">
                    <video id="video" class="d-block w-100" src="{{ asset('video/video2.mp4') }}" muted autoplay playsinline />
                    </div>
                    <div class="carousel-item">
                    <video id="video" class="d-block w-100" src="{{ asset('video/video3.mp4') }}" muted="" autoplay="" playsinline/>
                    </video>
                    </div>
                </div>
    ...
    <div class="row justify-content-center">
        <br>
        <h4 class="text-center pilares-title">Saiba quais são os 8 pilares que uso para um briefing assertivo e um plano de execução para desenvolver um projeto de valor e <u class="text-primary">RESULTADOS:</u></h4>
        <div class="col-md-4">
            ...
            <p id="m-a">Recomendo sempre mais de um domínio e nomes que tenham a ver com o nicho: .com e .br (caso seja um novo sistema)</p>
            ...
            <p id="m-a">Analiso suas maiores necessidades, com nossa experiência a maioria deles são quase sempre atrair mais clientes, melhorar o atendimento, investir e obter resultado, vender mais, ficar a frente dos concorrentes.</p>
        </div>
        <div class="col-md-4">
            <h5 class="pilares-subtitle"><i class="fas fa-check-circle text-primary"></i>&nbsp3 principais concorrentes;</h5>
            <p id="m-a">Procuro os principais concorrentes do seu nicho, para o desenvolvimento de um projeto que seja único e não saia atrás no mercado.</p>
            <h5 class="pilares-subtitle"><i class="fas fa-check-circle text-primary"></i>&nbspReferência de mercado;</h5>
            <p id="m-a">Desenvolvo uma estratégia de briefing para que desenvolvamos um projeto não só que solucione seus problemas, mas que vire referência no mercado.</p>
            <h5 class="pilares-subtitle"><i class="fas fa-check-circle text-primary"></i>&nbspLista de email marketing;</h5>
            <p id="m-a">Analiso que frequência seria ideal para sua lista de emails, e que ferramentas usar, tendo como referência os concorrentes.</p>
        ...
        <div class="col-lg-4 my-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>"Precisava de um site de roupas para expandir o meu negócio e o Lucas me ajudou muito criando um site com sistemas excepcionais integrados, já fechei mais de 2 negócios com ele"</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 my-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>"Sou Youtuber e precisava de um sistema para otimização dos meus roteiros, e o Lucas me ajudou muito nisso, criando um programa em que eu consigo definir toda trama dos meus textos de forma automatizada"</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 my-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>"Contratei o Lucas no intuito de que assumissem um cargo da minha equipe de TI, atualmente sou CTO de uma empresa de desenvolvimento e fiquei impressionado com o que foi entregue, muito mais do que o esperado, recomendo"</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container text-center justify-content-center my-4">
        ...
        <a href="https://api.whatsapp.com/send?phone=5511978512654"><button class="my-2 btn btn-primary contatBtnIndex">QUERO SABER MAIS!</button></a>
</div>
...
<div class="container-fluid bg-dark">
    <div class="container">
        <div class="row justify-content text-center ">
            ...
            <div class="col-lg-4">
                <a href="mailto:lucasdesouzacastellani@gmail.com"><i class="fas fa-envelope fa-3x my-3 text-light"></i></a>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row justify-content-center text-center text-light">
            ...
            <div class="col-lg-4 mb-3">
                lucasdesouzacastellani@gmail.com
            </div>
            <div class="col-lg-4 mb-3">
                +55 (11) 97851-2654
            </div>
